...
<div class="content">
    ...
    <div class="animated fadeIn">
        <div class="row" style="border:none;">
            <div class="col-md-6">
                <h5 class="card-title">Invoice Cum Paking List </h5>
            </div>
            <div class="col-md-6">
                <span class="right-brd" style="padding-right:15x;">
                    <ul class="">
                        ...
                        <li>/</li>
                        <li class="active">Invoice Cum Paking List</li>
                            ...
                            <thead>
                                ...
                                @foreach($data as $key => $buyer_record)
                                    <tr>
                                        ...
                                        <td> 
                                            <a href="{{url('export/edit-invoice-cum-packing/')}}/{{ $buyer_record->id }}"><i class="ti-pencil-alt"></i></a>
                                            {{-- <a href="#" title="Delete"><i class="ti-trash text-danger"></i></a> --}}
                                            <a href="{{ route('edit-invoice-cum-packing-pdf', ['id' => $buyer_record->id]) }}" title="Generate pdf"><i class="ti-book"></i></a>
