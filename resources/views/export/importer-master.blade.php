...
<div class="content">
    ...
    <div class="animated fadeIn">
        <div class="row" style="border:none;">
            <div class="col-md-6">
                <h5 class="card-title">Importer Master</h5>
            </div>
            <div class="col-md-6">
                <span class="right-brd" style="padding-right:15x;">
                    <ul class="">
                        ...
                        <li>/</li>
                        <li class="active">Importer Master</li>
            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="aply-lv">
                            <a href="{{url('export/add-importer-master')}}" class="btn btn-outline-info mb-2">
                                    Add Importer
                             </a>
                        ...
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>{{$val->crno}}</td>
                                  <td>{{$val->pobox}}</td>
                                  <td><a href="{{url('export/edit-importer-master/')}}/{{$val->id}}"><i class="ti-pencil-alt"></i></a>
