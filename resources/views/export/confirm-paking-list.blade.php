...
<div class="content">
    ...
    <div class="animated fadeIn">
        <div class="row" style="border:none;">
            <div class="col-md-6">
                <h5 class="card-title">Confirm Paking List</h5>
            </div>
            <div class="col-md-6">
                <span class="right-brd" style="padding-right:15x;">
                    <ul class="">
                        ...
                        <li>/</li>
                        <li class="active">Confirm Paking List</li>
                            ...
                            <thead>
                                ...
                                @foreach($data as $key => $buyer_record)
                                    <tr>
                                        ...
                                        <td> 
                                            <a href="{{url('export/edit-confirm-paking/')}}/{{ $buyer_record->id }}"><i class="ti-pencil-alt"></i></a>
