...
<div class="content">
    ...
    <div class="row" style="border:none;">
            <div class="col-md-6">
            <h5 class="card-title">Add Exporter Pass</h5>
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
								...
								<li>/</li>
                                <li class="active">Exporter Pass Add</li>
                        ...
                        <form action="{{ url('export/add-exporter-pass') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{-- <input type="text" id=""  name="importer_name1" class="form-control" required> --}}
                                ...
                                {{-- <div class="col-md-8">
                                    ...
                                    <textarea name="importer_address1" id="importer_address1" cols="4" rows="2" class="form-control" required></textarea>
                                </div> --}}
                                <div class="col-md-6">
                                    <label for="email-input" class=" form-control-label">Importer-2 </label>
                                    {{-- <input type="text" id=""  name="importer_name2" class="form-control" > --}}
                                ...
                                {{-- <div class="col-md-8">
                                    ...
                                    <textarea name="importer_address2" id="importer_address2" cols="4" rows="2" class="form-control"></textarea>
                                </div> --}}
                                <div class="col-md-3">
                                    <label for="email-input" class=" form-control-label">Means of Transport <span>(*)</span></label>
                                    <input type="text" id=""  name="means_of_transport" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="" name="marks_of_package" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="email-input" class=" form-control-label">Total Packages <span>(*)</span></label>
                                    <input type="text" id="" name="total_package" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id=""  name="invoice_no" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="email-input" class=" form-control-label">Export to <span>(*)</span></label>
                                    <input type="text" id=""  name="export_to" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="email-input" class=" form-control-label">Place <span>(*)</span></label>
                                    <input type="text" id=""  name="place" class="form-control" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="email-input" class=" form-control-label">Place Date <span>(*)</span></label>
                                    <input type="date" id=""  name="place_date" class="form-control" required>
                                </div>
