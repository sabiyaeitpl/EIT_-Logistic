            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{ url('export/update-box-master') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" value="{{ $boxMaster->id }}" name="id">
                            <div class="row form-group">

                                <div class="col-md-6">
                                    <label for="email-input" class=" form-control-label">Box/Bag <span>(*)</span></label>
                                    <input type="text" id="name" required name="box_name" class="form-control" value="{{ $boxMaster->box_name }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id=""  name="box_size" class="form-control"  value="{{ $boxMaster->box_size }}"  >
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="" name="box_weight" class="form-control"  value="{{ $boxMaster->box_weight }}" >
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="boxInr" name="box_price" class="form-control"  value="{{ $boxMaster->box_price }}" >
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="boxUsd" name="box_price_usd" class="form-control"  value="{{ $boxMaster->box_price_usd }}" >
                                    @if ($errors->has('box_price'))
                                    <div class="error" style="color:red;">{{ $errors->first('box_price') }}</div>
                                    @endif
                                </div>
