...
<div class="content">
    ...
    <div class="row" style="border:none;">
            <div class="col-md-6">
            <h5 class="card-title">Add Bank Master</h5>
</div>
<div class="col-md-6">
                           ...
                           <span class="right-brd" style="padding-right:15x;">
                            <ul class="">
								...
								<li>/</li>
                                <li class="active">Add Bank Master</li>
                            </ul>
                        </span>
</div>
</div>
            ...
            <div class="main-card">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{ url('export/save-bank-master') }}" method="post" enctype="multipart/form-data">
